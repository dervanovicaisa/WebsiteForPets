...
<!--                        <span class="input-group-addon">Search</span>-->
                        <input type="text" name="search_text" id="search_text" placeholder="Unesite naslov" class="form-control" />
                    </div>
                </div>
                <br/>
                <div id="result"></div>
...
//objave
    $(document).ready(function(){
        ...
        $(window).scroll(function(){
            if($(window).scrollTop() + $(window).height() > $(".postoviGrid").height()/2 && action == 'inactive')
            {
                action = 'active';
                start = start + limit;
                setTimeout(function(){
